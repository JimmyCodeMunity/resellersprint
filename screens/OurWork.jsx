...
const OurWork = ({ navigation }) => {
  ...
  const slides = [
    {
      id: 1,
      title: 'Sign Up',
      description: 'This platform has current price and dollar rates for your go-to Suppliers',
      image: require('../assets/use/account.png'),
    },
    {
      id: 2,
      title: 'Search for your desired manufacturer.',
      description: 'Are youa  reseller? Concentrate business, we have the PRICE LISTS.',
  ...
  return (
    <View className="flex-1 justify-center items-center bg-white">
      ...
      <Text className="text-lg px-5 text-center font-semibold">{slides[activeSlide].description}</Text>
      <TouchableOpacity className="bg-black my-4 rounded-2xl w-40 h-10 justify-center items-center" onPress={handleNext}>
